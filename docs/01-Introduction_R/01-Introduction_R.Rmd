...
- In *pairs of two*, play **10 games of rock-paper-scissors**. 
...
.details[
```{r}
rps = sample(c("R", "P", "S"), size = 10, replace = TRUE)
rps
```
]
...
trials = replicate(10000, {
  example = sample(c("R", "P", "S"), size = 10, replace = TRUE)
