...
> What is the probability of flipping *at least* 7 heads in 8 coin tosses, assuming the coin is fair? 🤔
...
.pull-right[
```{r, echo = FALSE, out.width = "75%"}
knitr::include_graphics("bob_ross.jpeg")
```
...
**1.** What is the probability that all of them show six?

**2.** What is the probability that **at least one** six appears?
...
The probabilities $P(A\mid B)$ and $P(B\mid A)$ are *linked* through **Bayes' Rule**: $$P(A\mid B)=\frac{P(B\mid A)P(A)}{P(B)}$$
